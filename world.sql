...
CREATE DATABASE IF NOT EXISTS `world` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `world`;
...
-- Dumping structure for table world.pages
...
-- Dumping structure for table world.user
...
-- Dumping data for table world.user: ~4 rows (approximately)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`ID`, `username`, `email`, `passHash`) VALUES
	(11, 'a', 'a@gmail.com', '$2y$10$QzHfGJjubrneM8mRTVuBcezJYuykvrxr2.cCQJktXvPAwyQieZGpC'),
	(12, 'a', 'c@gmail.com', '$2y$10$WnXwgWt8qNbOKA2nv5Jby.xQFFxUGdJPdry68tgNjDwrpB4QoW7rC'),
	(13, 'ab1748@gmail.com', 'ab1748@gmail.com', '$2y$10$qGUYJTo24fG/Nd9awV3zq.3jfvXAhhKF.6uMmR2fQYii8bRsszdru'),
	(14, 'g', 'ab1748@gmail.com', '$2y$10$bcU3yhku1T0SoACaOrBt6.6cEzZc7hPUJlksx.GYDChi1AxH9sBQC');
/*!40000 ALTER TABLE `user` ENABLE KEYS */;

-- Dumping structure for table world.userchoice
...
CREATE TABLE IF NOT EXISTS `userchoice` (
  ...
  KEY `FK_CityId` (`countryCode`) USING BTREE,
  CONSTRAINT `FK2_CountryCode` FOREIGN KEY (`countryCode`) REFERENCES `country` (`Code`),
  CONSTRAINT `FK_UserId` FOREIGN KEY (`userID`) REFERENCES `user` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=575 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table world.userchoice: ~69 rows (approximately)
DELETE FROM `userchoice`;
/*!40000 ALTER TABLE `userchoice` DISABLE KEYS */;
INSERT INTO `userchoice` (`ID`, `userID`, `countryCode`, `date`) VALUES
	(505, 11, 'ANT', '2020-02-27 11:02:13'),
	(506, 11, 'AIA', '2020-02-27 11:02:13'),
	(507, 11, 'AUT', '2020-02-27 11:02:13'),
	(508, 11, 'ABW', '2020-02-27 11:15:09'),
	(509, 11, 'ANT', '2020-02-27 11:15:09'),
	(510, 11, 'BHS', '2020-02-27 11:15:09'),
	(511, 11, 'ABW', '2020-02-27 11:15:57'),
	(512, 11, 'GUM', '2020-02-27 11:15:57'),
	(513, 11, 'KIR', '2020-02-27 11:16:27'),
	(514, 11, 'GUM', '2020-02-27 11:16:27'),
	(515, 11, 'KIR', '2020-02-27 11:37:55'),
	(516, 11, 'GUM', '2020-02-27 11:37:55'),
	(517, 11, 'KIR', '2020-02-27 11:38:13'),
	(518, 11, 'GUM', '2020-02-27 11:38:13'),
	(519, 11, 'KIR', '2020-02-27 11:38:25'),
	(520, 11, 'GUM', '2020-02-27 11:38:25'),
	(521, 11, 'AFG', '2020-02-27 11:38:25'),
	(522, 11, 'CAN', '2020-02-27 11:39:05'),
	(523, 11, 'USA', '2020-02-27 11:39:05'),
	(524, 11, 'GBR', '2020-02-27 11:39:05'),
	(525, 11, 'CAN', '2020-02-27 11:52:50'),
	(526, 11, 'USA', '2020-02-27 11:52:50'),
	(527, 11, 'GBR', '2020-02-27 11:52:50'),
	(528, 11, 'CAN', '2020-02-27 11:53:09'),
	(529, 11, 'USA', '2020-02-27 11:53:09'),
	(530, 11, 'GBR', '2020-02-27 11:53:09'),
	(531, 11, 'CAN', '2020-02-27 11:56:13'),
	(532, 11, 'USA', '2020-02-27 11:56:13'),
	(533, 11, 'GBR', '2020-02-27 11:56:13'),
	(534, 11, 'CAN', '2020-02-27 11:56:59'),
	(535, 11, 'USA', '2020-02-27 11:56:59'),
	(536, 11, 'GBR', '2020-02-27 11:56:59'),
	(537, 11, 'CAN', '2020-02-27 11:57:23'),
	(538, 11, 'USA', '2020-02-27 11:57:23'),
	(539, 11, 'UKR', '2020-02-27 11:57:23'),
	(540, 13, 'CAN', '2020-02-27 12:44:48'),
	(541, 13, 'USA', '2020-02-27 12:44:48'),
	(542, 13, 'UKR', '2020-02-27 12:44:48'),
	(543, 13, 'CAN', '2020-02-27 12:51:42'),
	(545, 13, 'CAN', '2020-02-27 14:24:27'),
	(546, 13, 'IRN', '2020-02-27 14:24:27'),
	(547, 13, 'PRK', '2020-02-27 14:24:27'),
	(548, 13, 'ABW', '2020-02-27 14:55:33'),
	(549, 13, 'ALB', '2020-02-27 14:55:33'),
	(550, 13, 'ARE', '2020-02-27 14:55:33'),
	(551, 13, 'ABW', '2020-02-27 14:55:55'),
	(552, 13, 'ALB', '2020-02-27 14:55:55'),
	(553, 13, 'ARE', '2020-02-27 14:55:55'),
	(554, 13, 'ABW', '2020-02-27 15:33:16'),
	(555, 13, 'ALB', '2020-02-27 15:33:16'),
	(556, 13, 'ARE', '2020-02-27 15:33:16'),
	(557, 13, 'ABW', '2020-02-27 15:33:25'),
	(558, 13, 'ALB', '2020-02-27 15:33:25'),
	(559, 13, 'ARE', '2020-02-27 15:33:25'),
	(560, 13, 'ABW', '2020-02-27 15:34:30'),
	(561, 13, 'ALB', '2020-02-27 15:34:30'),
	(562, 13, 'ARE', '2020-02-27 15:34:30'),
	(563, 13, 'ABW', '2020-02-27 15:44:26'),
	(564, 13, 'ALB', '2020-02-27 15:44:26'),
	(565, 13, 'ARE', '2020-02-27 15:44:26'),
	(566, 13, 'ABW', '2020-02-27 15:44:36'),
	(567, 13, 'ALB', '2020-02-27 15:44:36'),
	(568, 13, 'ARE', '2020-02-27 15:44:36'),
	(569, 13, 'ABW', '2020-02-27 15:56:51'),
	(570, 13, 'ALB', '2020-02-27 15:56:51'),
	(571, 13, 'ARE', '2020-02-27 15:56:51'),
	(572, 13, 'ABW', '2020-02-27 15:59:38'),
	(573, 13, 'ALB', '2020-02-27 15:59:38'),
	(574, 13, 'ARE', '2020-02-27 15:59:38');
